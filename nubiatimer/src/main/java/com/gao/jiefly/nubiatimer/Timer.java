...
//        end of line is round
        ...
        bundlePaint.setColor(Color.BLUE);
    }
...
//        Log.i(TAG, "textPaintSize:" + this.textPaint.getTextSize());
    ...
    private void generateAndSetBackground() {
        if (background == null) {
            String primaryColor = "#ffffff"; // any color code
            String primaryDarkColor = "#ffffff";
            background = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{ Color.parseColor(primaryColor),
